...
description: |-
  在 Stripe 集成决策上提供指引：API 选型（Checkout Sessions vs PaymentIntents）、Connect 平台搭建等。
en_description: |-
  Guides Stripe integration decisions across API selection (Checkout Sessions vs PaymentIntents) and Connect platform setup.
