...
description: |-
  在小红书运营店铺日常：管理库存与订单、处理客户购买、协调发货履约、规划店铺促销与活动。当用户要做店铺日常运营、商品上架、订单处理或活动策划时触发。
en_description: Manage Xiaohongshu shop daily ops: inventory, orders, fulfillment, promotions.
zh_displayName: 店铺运营
category: 品牌与设计
