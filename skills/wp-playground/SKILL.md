...
zh-desc: >-
  用作 WordPress Playground 的路由封装技能，适用于模糊的 Playground 工作、@wp-playground/cli 的本地 CLI 运行、playground.wordpress.net 分享链接、浏览器预览、快照、挂载、版本切换与 Xdebug。若要编写或审查 Blueprint JSON，请直接使用 blueprint 技能。
name: wp-playground
