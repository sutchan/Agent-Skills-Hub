...
description: |-
  遵循项目约定新增或修改 WooCommerce 后端 PHP 代码。在创建类、方法、钩子时使用。
en_description: |-
  Add or modify WooCommerce backend PHP code following project conventions. Use when creating new classes, methods, or hooks.
