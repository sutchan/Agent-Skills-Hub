...
en_description: Unified automation entry point covering browser automation (Playwright) and Windows desktop automation (OpenReverse): open pages, click, fill forms, scrape, screenshot, login automation, penetration page interaction, GUI tool operation (IDA/x64dbg), Windows UI Automation, vision-driven interaction, desktop network capture.
