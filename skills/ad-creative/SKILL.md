...
name: ad-creative
description: |-
  当用户需要为任意付费广告平台生成、迭代或规模化广告创意（标题、描述、主文案或完整广告变体）时使用。涵盖 RSA 标题、批量广告文案、创意测试、创意策略、创意复盘、钩子撰写、创意评审页、动态视频广告、无脸视频广告、动画解说广告、动态拼贴广告等场景。需要规模化产出广告文案或对现有广告迭代时使用；投放策略与定向见 ads 技能，落地页文案见 copywriting 技能。
