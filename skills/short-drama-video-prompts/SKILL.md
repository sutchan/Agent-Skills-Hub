...
description: |-
  为已接受的短剧镜头和关键帧编写或修改可复制的通用视频提示词与运动规格，也负责跨镜时间线配乐/主题曲的 provider-neutral 音乐规格。
en_description: |-
  Write or revise copy-paste universal video prompts and motion specs for accepted short-drama shots and keyframes, and own the provider-neutral music spec for cross-shot timeline scoring/theme songs.
