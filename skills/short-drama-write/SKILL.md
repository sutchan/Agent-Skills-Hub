...
description: |-
  编剧环节：创作或修订中文短剧、漫剧单集卡、因果节拍与可拍摄的 Markdown 剧本，也负责把现有中文剧本以保留原文、预览语义差异、创作者接受后发布的方式规范化。
en_description: |-
  Screenwriting stage: create or revise Chinese short-drama and manga single-episode cards, causal beats, and shootable Markdown scripts; also normalize existing Chinese scripts by preserving the original, previewing semantic diffs, and publishing only after creator acceptance.
