...
description: 编写或修订可拍摄的中文短剧、漫剧单集 Markdown 剧本，并负责规范化现成剧本。
en_description: Write or revise shootable Chinese short-drama / motion-comic episode scripts in Markdown, and normalize existing scripts.
zh_displayName: 短剧编剧
category: 品牌与设计
