...
description: |-
  通过 inference.sh CLI 使用 Google Veo、Seedance、Wan、Grok 等 40+ 模型生成 AI 视频。支持文生视频、图生视频、参考生视频、视频编辑、唇形同步、数字人动画、视频放大、拟音。适用于社媒视频、营销内容、解说视频、产品演示、AI 数字人。
