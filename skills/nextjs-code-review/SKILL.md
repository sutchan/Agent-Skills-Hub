...
zh: Next.js 代码审查
zh-desc: >-
  为 Next.js 应用提供全面的代码审查能力，校验 Server Components、Client Components、Server Actions、缓存策略、metadata、API 路由、middleware 与性能模式。在审查 Next.js App Router 代码改动、合并 PR 前、实现新功能后或进行架构校验时使用。
