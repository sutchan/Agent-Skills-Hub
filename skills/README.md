...
[![技能数量](https://img.shields.io/badge/skills-173-blue)](README.md) [![版本](https://img.shields.io/badge/version-v1.14.53-blue)](CHANGELOG.md) [![许可证](https://img.shields.io/badge/license-MIT-blue)](LICENSE) [![英文文档](https://img.shields.io/badge/docs-English-blue)](README.en.md)

> 作者：Sut Chan
>
> 项目地址：https://github.com/sutchan/Agent-Skills-Hub
>
> 一个集中管理的 AI 技能（Skill）集合，包含 173 个面向开发、设计、
...
- **[dart-flutter-patterns](skills/dart-flutter-patterns/)** — 生产可用的 Dart 与 Flutter 模式：空安全、不可变状态、异步组合、Widget 架构，以及 BLoC/Riverpod/Provider 状态管理、GoRouter 导航、Dio 网络与整洁架构。
...
- **[manim-video](skills/manim-video/)** — 基于 Manim Community Edition 的数学与技术动画生产管线，产出 3Blue1Brown 风格讲解视频、算法可视化、公式推导、架构图与数据故事。
...
`app/` 是项目 Web 应用的可开发源码工作区，用于实际开发、迭代与构建（具体技术栈见 [`app/README.md`](app/README.md)）。
...
- [行为准则](.github/CODE_OF_CONDUCT.md) — 社区参与的基本准则（Contributor Covenant）
- [安全政策](.github/SECURITY.md) — 漏洞私密报告渠道与项目安全红线
