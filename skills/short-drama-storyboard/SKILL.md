...
description: |-
  把中文短剧剧本与视觉设定写成含戏剧职责、连续性边界与冻结关键帧提示词的分镜 Markdown。
en_description: |-
  Turn Chinese short-drama scripts and visual settings into storyboard Markdown with dramatic roles, continuity boundaries, and frozen keyframe prompts.
zh_displayName: 短剧分镜
category: 音视频与多媒体
