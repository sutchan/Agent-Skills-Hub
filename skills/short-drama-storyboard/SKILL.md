...
description: |-
  把已接受的中文短剧剧本和资产转成原文落实表、有戏剧动机的镜头、连续性边界与冻结关键帧提示词；关键场次可先做场次视觉计划或 Coverage Audition 比对。
en_description: |-
  Turn an accepted Chinese short-drama script and assets into a shot list with source-line mapping, dramatically motivated shots, continuity boundaries, and frozen keyframe prompts; key scenes can get a scene visual plan or Coverage Audition comparison first.
zh_displayName: 短剧分镜表
category: 文档与内容
...
- 视觉方向已接受为漫剧 / 二维漫画形态，需要为关键帧投影共享画风与当前可读性约束时：
