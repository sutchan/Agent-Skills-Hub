...
description: 驱动运行在 Limrun 云端 Android 模拟器上的应用：安装 APK、启动与终止、交互操作。
en_description: Drive an app running on a Limrun cloud Android emulator: install an APK, launch and terminate, interact with the UI.
