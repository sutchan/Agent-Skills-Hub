...
[![版本](https://img.shields.io/badge/version-v1.19.7-blue)](CHANGELOG.md) [![许可证](https://img.shields.io/badge/license-MIT-blue)](LICENSE) [![英文文档](https://img.shields.io/badge/docs-English-blue)](README.en.md) [![技能数量](https://img.shields.io/badge/skills-动态-blue)](prototype/index.html)

> **作者**：Sut Chan ｜ **项目**：https://github.com/sutchan/Agent-Skills-Hub
>
> 一个集中管理的 AI 技能（Skill）集合，涵盖品牌设计、文档内容、数据分析、开发框架、文件格式、AI 与智能体、音视频、自动化集成与安全等领域，GitHub 上共 144 个技能包。
...
| 🗂️ | **144 技能 · 9 大领域** | 覆盖品牌与设计、文档与内容、数据分析与可视化、开发框架与平台、文件与格式处理、AI 与智能体、音视频与多媒体、自动化与集成、安全 |
