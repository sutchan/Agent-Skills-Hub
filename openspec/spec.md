...
> 路径：`openspec/spec.md` · 版本：1.14.48
...
- **版本权威源**：仓库根 `package.json` 的 `version`（当前 1.14.48）。README 中英文徽章、CHANGELOG 顶部须与之保持一致。
...
- 当前磁盘技能目录 **173** 个（与 README 声明、`data/skills-data.json` 的 `total` 一致）。
